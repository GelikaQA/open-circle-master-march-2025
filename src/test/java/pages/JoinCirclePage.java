...
public class JoinCirclePage extends BasePage {
    ...
    public void assertWarningMessageIncorrectPasscodeIsDisplayedOnJoinCirclePage(String incorrectPasscode) {
    ...
    public void assertWarningMessageForFirstNameIsDisplayedOnJoinCirclePage(String incorrectFirstName) {
