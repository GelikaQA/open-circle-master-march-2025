...
public class JoinCircleSteps {
    ...
    @And("enters {string} in the Passcode field on Join Circle Page")
    ...
    @And("At right side corner Warning message appears: {string}")
    ...
    @And("enters {string}{int}{string} in the Passcode field on the Join Circle page")
    public void entersInThePasscodeFieldOnTheJoinCirclePage(String arg0, int arg1, String arg2) {
        // TODO: implement if needed
    }

    @When("they enter <They press button \\{string} on the Join Circle page> in the field Circle Name on the Join Circle page")
    public void theyEnterTheyPressButtonStringOnTheJoinCirclePageInTheFieldCircleNameOnTheJoinCirclePage() {
        // TODO: implement if needed
    }

    @And("enters {string} in the Passcode field on the Join Circle page")
    public void entersInThePasscodeFieldOnTheJoinCirclePage(String arg0) {
        // TODO: implement if needed
    }

    @And("enters {string} in the First Name field on the Join Circle page")
    public void entersInTheFirstNameFieldOnTheJoinCirclePage(String arg0) {
        // TODO: implement if needed
    }

    @Then("they are still on the Join Circle page as the registration was not completed")
    public void theyAreStillOnTheJoinCirclePageAsTheRegistrationWasNotCompleted_Duplicate() {
        // Дубликат — можешь удалить или оставить, если надо
    }

    @And("At right side corner Warning message appears: {string}y again' |")
    public void andAtRightSideCornerWarningMessageAppearsIncorrectPasscodePleaseTryAgainYAgain() {
        // TODO: fix step definition if needed
    }
}
